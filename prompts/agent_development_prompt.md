...
1. **Single Augmented LLM Call** - For straightforward tasks with clear inputs/outputs
   ...
   - _Example_: Simple question answering, formatting, or data extraction
   - _Implementation_: Direct API call with appropriate prompting
...
2. **Fixed Workflow Patterns** - For predictable, decomposable tasks with known steps
   ...
   - _Implementation_: Orchestrated sequence of LLM calls with intermediate steps
...
3. **Autonomous Agents** - For complex, unpredictable tasks requiring dynamic planning
   ...
   - _Implementation_: Agent loop with planning, execution, and feedback cycles
...
_Use for complex tasks requiring decomposition_
...
_Use for tasks requiring quality assessment and refinement_
...
_Use for classifying and handling different types of requests_

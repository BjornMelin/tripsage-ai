"""Pydantic models for accommodation-related interactions.

These models provide validated schemas for MCP clients and accommodation services.
Moved from tripsage.tools.models.accommodations to tripsage_core for shared use.
"""

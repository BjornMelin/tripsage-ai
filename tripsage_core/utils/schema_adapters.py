...
class SchemaAdapter:
    ...
    @staticmethod
    def migrate_legacy_preferences(flexibility: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        preferences = {
            ...
            'destination_flexibility': flexibility.get('destination_flexibility', False),
...
class MemorySchemaAdapter:
    ...
    @staticmethod
    def create_mem0_collection_data(name: str, description: str = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def convert_tripsage_memory_to_mem0(tripsage_memory: Dict[str, Any], 
        ...
        return {
            ...
            'created_at': tripsage_memory.get('created_at', datetime.utcnow().isoformat()),
            'updated_at': datetime.utcnow().isoformat(),
        }
...
class DatabaseQueryAdapter:
    ...
    def build_trip_filter_where_clause(trip_id: str) -> tuple[str, dict]:
        ...
        if SchemaAdapter.is_uuid(trip_id):
            return "WHERE uuid_id = %(trip_id)s OR id::text = %(trip_id)s", {'trip_id': trip_id}
        else:
            try:
...
def log_schema_usage(operation: str, id_type: str, field_mappings: Dict[str, str] = None):
    """

...
class BenchmarkRunner:
    """Simple benchmark runner focused on core metrics."""

    def __init__(self, config: Optional[BenchmarkConfig] = None, output_dir: Optional[Path] = None):
    ...
    async def run_quick_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            report_path = await self.reporter.generate_simple_report(report_data, "quick_test")
    ...
    async def run_database_only(self) -> Dict[str, Any]:
        ...
        try:
            ...
            report_path = await self.reporter.generate_simple_report(report_data, "database_only")
            report_data["report_path"] = str(report_path)
    ...
    async def run_vector_only(self) -> Dict[str, Any]:
        ...
        try:
            ...
            report_path = await self.reporter.generate_simple_report(report_data, "vector_only")
            report_data["report_path"] = str(report_path)
    ...
    async def run_full_suite(self) -> Dict[str, Any]:
        ...
        try:
            ...
            report_path = await self.reporter.generate_simple_report(report_data, "full_suite")
            report_data["report_path"] = str(report_path)
    ...
    async def _run_core_scenarios(self, duration_seconds: int, iterations: int, concurrent_users: int) -> Dict[str, Any]:
    ...
    async def _run_database_scenarios(self, duration_seconds: int, iterations: int, concurrent_users: int) -> Dict[str, Any]:
    ...
    async def _run_vector_scenarios(self, duration_seconds: int, iterations: int, concurrent_users: int) -> Dict[str, Any]:
    ...
    async def _run_mixed_scenarios(self, duration_seconds: int, iterations: int, concurrent_users: int) -> Dict[str, Any]:
    ...
    def _validate_optimization_claims(self, database_results: Dict, vector_results: Dict, mixed_results: Dict) -> Dict[str, Any]:

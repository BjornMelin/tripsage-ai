    ...
    async def check_prerequisites(self) -> bool:
        ...
        try:
            ...
            required_tables = [
                ...
                'chat_sessions', 'chat_messages', 'file_attachments',
                'memories', 'session_memories', 'users'
            ]
    ...
    async def test_trigger_functionality(self) -> bool:
        ...
        try:
            ...
            trip_result = await self.db_service.execute_query(
                ...
                RETURNING id
                """,
                owner_id, "Trigger Test Trip", "Test City", "2025-12-01", "2025-12-10", "planning"
            )
    ...
    async def setup_pg_cron_jobs(self) -> bool:
        ...
        try:
            ...
            jobs = [
                ...
                ('search-cache-cleanup', '0 */6 * * *', 'SELECT cleanup_expired_search_cache();'),
                ('expire-sessions', '0 * * * *', 'SELECT expire_inactive_sessions(24);')
            ]

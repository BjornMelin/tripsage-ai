...
class StorageDeployment:
    ...
    async def run_storage_migration(self) -> bool:
        ...
        try:
            migration_file = self.project_root / "supabase" / "migrations" / "20250111_01_add_storage_infrastructure.sql"
    ...
    async def verify_buckets(self) -> bool:
        ...
        try:
            expected_buckets = ["attachments", "avatars", "trip-images", "thumbnails", "quarantine"]

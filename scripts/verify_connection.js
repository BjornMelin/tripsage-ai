...
if (!supabaseUrl || !supabaseKey) {
  console.error('ERROR: Missing environment variables SUPABASE_URL and/or SUPABASE_ANON_KEY');
...
async function verifyConnection() {
  ...
  try {
    ...
    if (tablesError) {
      console.log('Unable to list tables using RPC. Using alternative method...');

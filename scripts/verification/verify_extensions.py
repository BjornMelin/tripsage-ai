...
class ExtensionVerifier:
    ...
    async def run_comprehensive_check(self):
        ...
        console.print("="*60)
        if all_passed:
            console.print("🎉 All checks passed! Extensions are properly configured.", style="bold green")
        else:
...
async def main():
    ...
    if not database_url:
        console.print("❌ No database URL found. Set SUPABASE_DB_URL or DATABASE_URL environment variable.", style="red")
        sys.exit(1)

...
class ExtensionDeployer:
    ...
    async def run_migration(self) -> bool:
        ...
        migration_file = Path(__file__).parent.parent.parent / "supabase" / "migrations" / "20250611_02_enable_automation_extensions.sql"
    ...
    async def full_deployment(self):
        ...
        if all_steps_passed and all_verifications_passed:
            ...
            console.print("⚠️  Deployment completed with issues. Review output above.", style="bold yellow")

...
def analyze_workflows():
    ...
    security_workflows = [wf for wf in workflows if 'security' in workflows[wf]['name'].lower()]
    ...
    coverage_workflows = [wf for wf in workflows if 'coverage' in workflows[wf]['name'].lower()]

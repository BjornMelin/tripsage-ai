...
- **Frontend-first architecture:** New capabilities must be implemented in `frontend/` using:
  ...
  - AI SDK core `ai@6.0.0-beta.127` and `@ai-sdk/react@3.0.0-beta.127`
  - Providers: `@ai-sdk/openai@3.0.0-beta.75`, `@ai-sdk/anthropic@3.0.0-beta.70`, `@ai-sdk/xai@3.0.0-beta.48`
  - Supabase: `@supabase/ssr@0.8.0`, `@supabase/supabase-js@2.84.0`

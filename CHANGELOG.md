...
- **Provider migration: Expedia Rapid → Amadeus + Google Places + Stripe**
  ...
  - Accommodation guardrails keep cached results tagged with the original provider and surface 429/404 responses as availability errors; booking confirmations fall back to generated references when Expedia omits a confirmation number.

...
class WebCrawlPersistence:
    ...
    async def _store_in_memory(self, result: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            observations.append(f"Timestamp: {result.get('timestamp', datetime.utcnow().isoformat())}")
            ...
            logger.info(f"Successfully stored result in Memory MCP knowledge graph: {entity_name}")
            return True
    ...
    async def _store_events_in_memory(self, result: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            await self.memory_client.create_entities([{
                ...
                "observations": [
                    f"Events were searched for this destination on {datetime.utcnow().isoformat()}"
                ]
            }])
            ...
            logger.info(f"Successfully stored events in Memory MCP knowledge graph for {destination_name}")
            return True
    ...
    async def _store_blog_in_memory(self, result: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully stored blog in Memory MCP knowledge graph: {blog_name}")
            return True

...
class SourceSelector:
    ...
    CONTENT_TYPE_MAPPING: Dict[str, SourceType] = {
        ...
        'destination_info': SourceType.CRAWL4AI, # Crawl4AI better at general travel info
    }
    ...
    def select_source(
        ...
        Args:
            ...
            extraction_complexity: Complexity of extraction ("simple", "moderate", "complex")
        ...
        if content_type and content_type in self.CONTENT_TYPE_MAPPING:
            ...
            logger.debug(f"Selected {selected_source} based on content type: {content_type}")
        ...
        if domain:
            if domain in self.FIRECRAWL_OPTIMIZED_DOMAINS:
                ...
                logger.debug(f"Selected {selected_source} based on optimized domain: {domain}")
                return selected_source
        ...
        if extraction_complexity == "complex":
            selected_source = SourceType.FIRECRAWL  # Firecrawl's structured extraction is better

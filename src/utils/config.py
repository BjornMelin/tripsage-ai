...
def get_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "WEBCRAWL_MCP_API_KEY": (
            settings.webcrawl_mcp.api_key.get_secret_value()
        ...
        "BROWSER_MCP_API_KEY": (
            settings.browser_mcp.api_key.get_secret_value()
        ...
        "FLIGHTS_MCP_API_KEY": (
            settings.flights_mcp.api_key.get_secret_value()
        ...
        "GOOGLE_MAPS_MCP_API_KEY": (
            settings.google_maps_mcp.api_key.get_secret_value()
        ...
        "MEMORY_MCP_API_KEY": (
            settings.memory_mcp.api_key.get_secret_value()
            if settings.memory_mcp.api_key
            else None
        ),
        # Sequential Thinking MCP
        "SEQ_THINKING_MCP_ENDPOINT": settings.sequential_thinking_mcp.endpoint,
        "SEQ_THINKING_MCP_API_KEY": (
            settings.sequential_thinking_mcp.api_key.get_secret_value()

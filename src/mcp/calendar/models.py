"""
Google Calendar MCP models for TripSage.

This module provides Pydantic models for the Google Calendar MCP client,
defining data structures for calendars, events, and API parameters/responses.
"""
...
class EventAttendee(BaseModel):
    ...
    display_name: Optional[str] = Field(None, description="Display name of the attendee")
    response_status: Optional[str] = Field(
        None, description="Attendee's response status (accepted, declined, needsAction, tentative)"
    )
...
class Event(BaseModel):
    ...
    calendar_id: Optional[str] = Field(None, description="ID of the calendar containing the event")
    ...
    html_link: Optional[HttpUrl] = Field(None, description="Link to the event in Google Calendar")
    ...
    attendees: Optional[List[EventAttendee]] = Field(None, description="List of attendees")
    ...
    visibility: Optional[EventVisibility] = Field(None, description="Visibility of the event")
    conference_data: Optional[Dict] = Field(None, description="Conference data for the event")
...
class ListCalendarsParams(BaseModel):
    ...
    max_results: Optional[int] = Field(None, description="Maximum number of calendars to return")
...
class ListEventsParams(BaseModel):
    ...
    max_results: Optional[int] = Field(None, description="Maximum number of events to return")
...
class UpdateEventParams(BaseModel):
    ...
    attendees: Optional[List[EventAttendee]] = Field(None, description="New list of attendees")
    reminders: Optional[Dict[str, List[EventReminder]]] = Field(
...
class ItineraryItem(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Description of the itinerary item")
...
class CreateItineraryEventsParams(BaseModel):
    ...
    trip_name: Optional[str] = Field(None, description="Name of the trip for event grouping")


class CreateItineraryEventsResponse(BaseModel):

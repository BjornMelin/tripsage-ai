    ...
    "parameters": {
        ...
        "properties": {
            "destinations": {
                "type": "array",
                "items": {"type": "string"},
                "description": "List of destinations to compare (e.g., ['Paris, FR', 'London, GB'])"
            },
            "date": {
                "type": "string",
                "format": "date",
                "description": "Date for comparison (YYYY-MM-DD). If not provided, uses current date."
            }
        },
...
GET_OPTIMAL_TRAVEL_TIME_SCHEMA = {
    ...
    "description": "Get recommendations for the optimal time to travel to a destination",
    "parameters": {
        "type": "object",
        "properties": {
            "destination": {
            ...
            "activity_type": {
                "type": "string",
                "description": "Type of activity planned (e.g., 'beach', 'skiing', 'sightseeing')",
                "default": "general"
            },
            "months_ahead": {
                "type": "integer",

...
from .neon.client import NeonMCPClient, NeonService, get_client as get_neon_client
from .supabase.client import SupabaseMCPClient, SupabaseService, get_client as get_supabase_client
...
def get_mcp_service(environment: Optional[str] = None) -> Union[NeonService, SupabaseService]:
    """
...
class DatabaseMCPFactory:
    ...
    @staticmethod
    def get_client(environment: Optional[str] = None) -> Union[NeonMCPClient, SupabaseMCPClient]:
        """
        Get the appropriate database MCP client based on the environment.
    ...
    @staticmethod
    def get_service(environment: Optional[str] = None) -> Union[NeonService, SupabaseService]:
        """
        Get the appropriate database MCP service based on the environment.

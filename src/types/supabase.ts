...
export type SearchParameters =
  Database["public"]["Tables"]["search_parameters"]["Row"];
...
export type TripComparison =
  Database["public"]["Tables"]["trip_comparison"]["Row"];
...
export type SavedOptionInsert =
  Database["public"]["Tables"]["saved_options"]["Insert"];
export type TripComparisonInsert =
  Database["public"]["Tables"]["trip_comparison"]["Insert"];
...
export type TransportationUpdate =
...
export type SearchParametersUpdate =
  Database["public"]["Tables"]["search_parameters"]["Update"];
export type TripNoteUpdate =
  Database["public"]["Tables"]["trip_notes"]["Update"];
export type PriceHistoryUpdate =
  Database["public"]["Tables"]["price_history"]["Update"];
export type SavedOptionUpdate =
  Database["public"]["Tables"]["saved_options"]["Update"];
export type TripComparisonUpdate =
  Database["public"]["Tables"]["trip_comparison"]["Update"];

...
Automates database schema deployment to Supabase with validation and rollback capability.
"""
...
class DatabaseDeployer:
    ...
    def check_prerequisites(self) -> bool:
        ...
        try:
            ...
            self.log_step(f"Supabase CLI Found", True, f"Version: {result.stdout.strip()}")
        except (subprocess.CalledProcessError, FileNotFoundError):
            self.log_step("Supabase CLI Check", False, "CLI not found - install from https://supabase.com/docs/guides/cli")
            return False
        
        # Check schema files exist
        required_files = [
            "00_extensions.sql", "01_tables.sql", "02_indexes.sql",
            "03_functions.sql", "04_triggers.sql", "05_policies.sql", "06_views.sql"
        ]
    ...
    def validate_schema_syntax(self) -> bool:
        ...
        try:
            result = subprocess.run([sys.executable, "validate_database_schema.py"], 
                                  capture_output=True, text=True, check=True)
...
""")
    ...
    def deploy_to_production(self) -> bool:
        ...
        try:
            ...
            subprocess.run(["supabase", "link", "--project-ref", self.project_ref], 
    ...
    def verify_deployment(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run([sys.executable, "test_database_integration.py"], 
                                  capture_output=True, text=True, check=True)
    ...
    def deploy(self, target: str = "local") -> bool:
        ...
        print(f"🚀 TripSage Database Schema Deployment")
        ...
        print(f"   Tables: 12")
        print(f"   Indexes: 38") 
        print(f"   RLS Policies: 17")
        print(f"   Functions: 12")
...
def main():
    ...
    parser.add_argument("--project-ref", 
                       help="Supabase project reference for production deployment")

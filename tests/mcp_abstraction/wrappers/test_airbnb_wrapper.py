    ...
    async def test_invoke_search_methods(self, mock_settings, mock_airbnb_client):
        ...
        with patch(settings_path, mock_settings):
            ...
            for method in methods:
                ...
                mock_airbnb_client.search_accommodations.assert_called_with(
                    **search_params
                )
    ...
    async def test_invoke_get_listing_methods(self, mock_settings, mock_airbnb_client):
        ...
        with patch(settings_path, mock_settings):
            ...
            for method in methods:
                ...
                assert result == mock_response
                mock_airbnb_client.get_listing_details.assert_called_with(
                    **listing_params
                )

    @pytest.mark.asyncio
    async def test_invoke_check_availability_methods(
        self, mock_settings, mock_airbnb_client
    ):

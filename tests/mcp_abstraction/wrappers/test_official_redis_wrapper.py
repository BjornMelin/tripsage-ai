...
class TestOfficialRedisMCPClient:
    ...
    async def test_set_without_ttl(self, client):
        ...
        with patch(
            ...
            assert result is True
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="set", key="test_key", value="test_value"
            )
    ...
    async def test_get_success(self, client):
        ...
        with patch(
            ...
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="get", key="test_key"
            )
    ...
    async def test_delete_single_key(self, client):
        ...
        with patch(
            ...
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="delete", key="test_key"
            )
    ...
    async def test_delete_multiple_keys(self, client):
        ...
        with patch(
            ...
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="delete", key=keys
            )
    ...
    async def test_list_keys(self, client):
        ...
        with patch(
            ...
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="list", pattern="test:*"
            )
    ...
    async def test_list_keys_default_pattern(self, client):
        ...
        with patch(
            ...
            assert result == ["key1"]
            mock_invoke.assert_called_once_with(
                mcp_name="redis", method_name="list", pattern="*"
            )

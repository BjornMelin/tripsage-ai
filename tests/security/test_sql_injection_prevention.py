...
class TestSQLInjectionPrevention:
    ...
    async def test_sql_injection_in_api_key_creation(self, api_key_service, sql_injection_payloads):
        ...
        api_key_service.db.transaction.return_value.__aenter__.return_value.execute.return_value = [
        ...
        for payload in sql_injection_payloads:
            ...
            with patch.object(api_key_service, 'validate_api_key') as mock_validate:
                ...
                try:
                    ...
                    # The name should be treated as a parameter, not concatenated into SQL
    ...
    def test_database_error_message_sanitization(self, api_key_service):
        ...
        sensitive_error = "ERROR: relation 'api_keys_secret_table' does not exist at line 1: SELECT * FROM api_keys_secret_table WHERE secret_field = 'sensitive_data'"

...
class TestUnifiedSearchService:
    ...
    async def test_search_destinations_query_only(self, unified_search_service):
        ...
        request = UnifiedSearchRequest(query="things to do in tokyo destination guide")
    ...
    async def test_search_destinations_no_match(self, unified_search_service):
        ...
        request = UnifiedSearchRequest(query="restaurant recommendations")
    ...
    async def test_search_activities_with_filters(
        self, unified_search_service, mock_activity_service, sample_search_filters
    ):
    ...
    async def test_search_activities_error(self, unified_search_service):
        ...
        request = UnifiedSearchRequest(query="activities", destination="Test City")
    ...
    async def test_search_flights_not_implemented(self, unified_search_service):
        ...
        request = UnifiedSearchRequest(query="flights", origin="NYC", destination="LAX")
    ...
    async def test_search_accommodations_not_implemented(self, unified_search_service):
        ...
        request = UnifiedSearchRequest(query="hotels", destination="Paris, France")
    ...
    def test_apply_unified_filters_price_range(self, unified_search_service):
        ...
        results = [
            ...
            SearchResultItem(
                ...
                type="activity",
                title="Affordable",
                description="Affordable activity",
                relevance_score=0.7,
                price=25.0,
            ),
            SearchResultItem(
    ...
    def test_apply_unified_filters_rating(self, unified_search_service):
        ...
        results = [
            SearchResultItem(
                ...
                type="activity",
                title="High Rated",
                description="High rated activity",
                relevance_score=0.8,
                rating=4.5,
            ),
            SearchResultItem(
                ...
                type="activity",
                title="Low Rated",
                description="Low rated activity",
                relevance_score=0.7,
                rating=3.0,
            ),
            SearchResultItem(
                ...
                type="activity",
                title="No Rating",
                description="No rating activity",
                relevance_score=0.6,
                rating=None,
            ),
        ]

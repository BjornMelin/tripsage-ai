...
class TestApiKeyServiceModern:
    ...
    @pytest.mark.asyncio
    async def test_validate_api_key_with_caching(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_encryption_decryption_cycle(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_validation_safety(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_service_health_check(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_rate_limiting_validation(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_comprehensive_edge_cases(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_update_api_key_functionality(self, api_key_service: ApiKeyService):
        ...
        await api_key_service.update_api_key(key_id, update_data)
    ...
    @pytest.mark.asyncio
    async def test_delete_api_key_functionality(self, api_key_service: ApiKeyService):
    ...
    @pytest.mark.asyncio
    async def test_list_user_api_keys(self, api_key_service: ApiKeyService):
...
class TestApiKeyServicePropertyBased:
    ...
    @given(key_data=st.binary(min_size=1, max_size=1000))
    def test_encryption_decryption_properties(self, key_data: bytes):
        ...
        service = ApiKeyService(db=Mock(), cache=Mock(), settings=mock_settings)

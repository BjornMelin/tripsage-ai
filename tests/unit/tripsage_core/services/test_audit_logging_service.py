...
class TestSecurityAuditLogger:
    ...
    async def test_query_events(self, audit_logger, temp_log_dir):
        ...
        auth_events = await audit_logger.query_events(
            event_types=[AuditEventType.AUTH_LOGIN_SUCCESS, AuditEventType.AUTH_LOGIN_FAILED]
        )
...
class TestConvenienceFunctions:
    ...
    async def test_audit_authentication(self):
        ...
        with patch('tripsage_core.services.business.audit_logging_service.get_audit_logger') as mock_get_logger:

...
class DatabaseServiceTestRunner:
    ...
    def run_unit_tests(self, verbose: bool = True, coverage: bool = True) -> Dict[str, Any]:
        ...
        pytest_args = [
            ...
            "--strict-markers",
            "--disable-warnings",
            "-m", "not slow and not integration and not chaos",
        ]
        
        if coverage:
            pytest_args.extend([
                f"--cov={self.project_root / 'tripsage_core' / 'services' / 'infrastructure'}",
    ...
    def run_performance_tests(self, benchmark_save: Optional[str] = None) -> Dict[str, Any]:
        ...
        print(f"⚡ Performance tests completed in {duration:.2f}s (exit code: {exit_code})")
        return result
    ...
    def run_integration_tests(self) -> Dict[str, Any]:
        ...
        print(f"🔗 Integration tests completed in {duration:.2f}s (exit code: {exit_code})")
        return result
    ...
    def run_property_tests(self) -> Dict[str, Any]:
        ...
        print(f"🎯 Property tests completed in {duration:.2f}s (exit code: {exit_code})")
        return result
    ...
    def generate_coverage_report(self) -> Dict[str, Any]:
        ...
        pytest_args = [
            ...
            "--tb=no",
            "--disable-warnings",
            "-m", "not slow and not integration",  # Skip slow tests for coverage
            f"--cov={self.project_root / 'tripsage_core' / 'services' / 'infrastructure'}",
    ...
    def run_mutation_testing(self) -> Dict[str, Any]:
        ...
        target_module = str(
            self.project_root / "tripsage_core" / "services" / "infrastructure" / "database_service.py"
        )
        ...
        try:
            ...
            cmd = [
                ...
                "--tests-dir", str(self.infrastructure_tests),
                "--runner", "python -m pytest",
            ]

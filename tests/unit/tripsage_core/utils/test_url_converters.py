...
class TestDatabaseURLConverter:
    ...
    def test_supabase_to_postgres_basic(self, converter):
        ...
        expected = (
            "postgresql://postgres:test-service-key@"
            "myproject.db.supabase.co:5432/postgres?sslmode=require"
        )
    ...
    def test_supabase_to_postgres_with_pooler(self, converter):
        ...
        expected = (
            "postgresql://postgres:test-service-key@"
            "myproject.db.supabase.co:6543/postgres?sslmode=require"
        )
        assert result == expected
    ...
    def test_supabase_to_postgres_custom_params(self, converter):
        ...
        expected = (
            "postgresql://custom_user:test-key@"
            "myproject.db.supabase.com:5432/custom_db?sslmode=prefer"
        )
        assert result == expected
...
class TestEdgeCases:
    ...
    def test_special_project_names(self, converter):
        ...
        result = converter.supabase_to_postgres(
            "https://my-test-project-123.supabase.co",
            "password"
        )
    ...
    def test_url_with_path_ignored(self, converter):
        ...
        result = converter.supabase_to_postgres(
            "https://myproject.supabase.co/some/path",
            "password"
        )

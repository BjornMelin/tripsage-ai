...
class TestAccommodationTools:
    ...
    async def test_get_airbnb_listing_details_success(self):
        ...
        mock_accommodation_service = MagicMock()
        mock_accommodation_service.get_accommodation_details = AsyncMock(return_value={
            "status": "success",
            "details": {
                "id": "listing1",
    ...
    async def test_book_accommodation_tool_success(self):
        ...
        mock_accommodation_service = MagicMock()
        mock_accommodation_service.book_accommodation = AsyncMock(return_value={
            "status": "success",
    ...
    async def test_service_registry_missing_accommodation_service(self):
        ...
        with pytest.raises(ValueError, match="Required service accommodation_service not available"):

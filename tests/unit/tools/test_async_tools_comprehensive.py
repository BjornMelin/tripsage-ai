...
class TestAsyncToolsPattern:
    ...
    async def test_accommodations_tools_async_pattern(self):
        ...
        mock_service.search_accommodations = AsyncMock(return_value={
            "status": "success",
            "accommodations": [
                {
                    "id": "hotel_123",
    ...
    async def test_web_crawl_tools_async_pattern(self):
        ...
        mock_registry = MagicMock()
        mock_service = AsyncMock()
        mock_service.crawl_url = AsyncMock(return_value={
            "status": "success",
    ...
    async def test_planning_tools_async_pattern(self):
        ...
        with patch('tripsage.tools.planning_tools.redis_cache') as mock_cache, \
    ...
    async def test_concurrent_tool_execution(self):
        ...
        accommodation_service.search_accommodations = AsyncMock(return_value={"status": "success", "accommodations": []})
        ...
        results = await asyncio.gather(
            ...
            search_memory_tool(
                ...
                service_registry=memory_registry
            )
        )
...
class TestToolsIntegrationScenarios:
    ...
    async def test_multi_tool_accommodation_search_workflow(self):
        ...
        from tripsage.tools.accommodations_tools import search_accommodations_tool, book_accommodation_tool
        ...
        # Mock booking
        mock_service.book_accommodation = AsyncMock(return_value={
            "status": "success",

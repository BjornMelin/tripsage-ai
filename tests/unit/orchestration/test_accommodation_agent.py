...
class TestAccommodationAgentNode:
    ...
    def accommodation_node(self, mock_service_registry, mock_llm):
        ...
        with patch("tripsage.orchestration.nodes.accommodation_agent.ChatOpenAI", return_value=mock_llm):
    ...
    def sample_state(self):
        ...
        state = create_initial_state(
            "user-123",
            "I need a hotel in Tokyo for next week, preferably near Shibuya"
        )
        state["travel_dates"] = {
    ...
    @pytest.mark.asyncio
    async def test_no_search_parameters_extracted(
        self, accommodation_node, mock_llm
    ):
        ...
        mock_llm.ainvoke.side_effect = [
            ...
            MagicMock(content="I'd be happy to help you find accommodations! To search for the best options, I'll need to know your destination, check-in and check-out dates, and any preferences you have for the type of property or amenities.")  # General response
        ]

...
class TestSimpleTripSageOrchestrator:
    ...
    @patch('tripsage.orchestration.simple_graph.get_settings')
    @pytest.mark.asyncio
    async def test_process_conversation_error_handling(self, mock_settings, mock_get_tools, mock_create_agent, mock_openai):
...
class TestOrchestratorBackwardsCompatibility:
    ...
    def test_tripsage_orchestrator_alias(self):
        ...
        from tripsage.orchestration import TripSageOrchestrator, SimpleTripSageOrchestrator
...
class TestIntegrationScenarios:
    ...
    @patch('tripsage.orchestration.simple_graph.get_settings')
    @pytest.mark.asyncio
    async def test_travel_planning_conversation_flow(self, mock_settings, mock_get_tools, mock_create_agent, mock_openai):

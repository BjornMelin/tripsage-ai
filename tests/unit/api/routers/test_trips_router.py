...
class TestTripsRouter:
    ...
    async def test_get_trip_suggestions_with_combined_filters(
        self, mock_principal, mock_trip_service
    ):
    ...
    async def test_get_trip_suggestions_no_matching_filters(
        self, mock_principal, mock_trip_service
    ):
    ...
    async def test_get_trip_suggestions_edge_case_zero_limit(
        self, mock_principal, mock_trip_service
    ):
    ...
    async def test_get_trip_suggestions_all_categories(
        self, mock_principal, mock_trip_service
    ):
    ...
    async def test_get_trip_suggestions_all_suggestion_ids(
        self, mock_principal, mock_trip_service
    ):

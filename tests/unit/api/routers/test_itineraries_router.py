...
class TestItinerariesRouter:
    ...
    def sample_update_request(self):
        ...
        return ItineraryUpdateRequest(title="Updated Tokyo Trip", description="Updated description")
    ...
    def sample_item_update_request(self):
        ...
        return ItineraryItemUpdateRequest(title="Updated Activity", notes="Updated notes for the activity")
    ...
    def sample_optimize_request(self):
        ...
        return ItineraryOptimizeRequest(itinerary_id="itinerary123", settings=OptimizationSetting.TIME)
    ...
    async def test_create_itinerary_success(self, mock_principal, mock_itinerary_service, sample_create_request):
        ...
        result = await create_itinerary(sample_create_request, mock_principal, mock_itinerary_service)
    ...
    async def test_search_itineraries_no_results(self, mock_principal, mock_itinerary_service):
        ...
        search_request = ItinerarySearchRequest(query="Nonexistent", page=1, page_size=10)
        expected_response = {
            "itineraries": [],
            "total_count": 0,
            "page": 1,
    ...
    async def test_get_itinerary_success(self, mock_principal, mock_itinerary_service):
        ...
        expected_itinerary = {
            ...
            "description": "5-day trip exploring Tokyo",
            "user_id": "user123",
            "items": [{"id": "item1", "title": "Visit Tokyo Tower", "location": "Tokyo Tower"}],
        }
    ...
    async def test_update_itinerary_success(self, mock_principal, mock_itinerary_service, sample_update_request):
        ...
        result = await update_itinerary(itinerary_id, sample_update_request, mock_principal, mock_itinerary_service)

        mock_itinerary_service.update_itinerary.assert_called_once_with("user123", itinerary_id, sample_update_request)

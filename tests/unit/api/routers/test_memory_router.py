...
class TestMemoryRouter:
    ...
    def sample_conversation_request(self):
        ...
        return ConversationMemoryRequest(
            messages=[
                ...
                {"role": "assistant", "content": "I'd be happy to help you plan your Tokyo trip!"}
            ],
    ...
    def sample_search_request(self):
        ...
        return SearchMemoryRequest(
            query="Tokyo travel preferences",
            limit=5
        )
    ...
    async def test_add_conversation_memory_success(self, mock_principal, mock_memory_service, sample_conversation_request):
    ...
    async def test_add_conversation_memory_without_session_id(self, mock_principal, mock_memory_service):
        ...
        expected_result = {"memory_id": "mem456", "status": "success", "messages_stored": 1}
        mock_memory_service.add_conversation_memory.return_value = expected_result
    ...
    async def test_add_conversation_memory_service_error(self, mock_principal, mock_memory_service, sample_conversation_request):
    ...
    async def test_get_user_context_success(self, mock_principal, mock_memory_service):
        ...
        expected_context = {
            ...
            "travel_history": [
                {"destination": "Tokyo, Japan", "dates": "2023-05-01 to 2023-05-07", "rating": 5}
            ],
            "recent_searches": [
    ...
    async def test_update_preferences_service_error(self, mock_principal, mock_memory_service, sample_preferences_request):

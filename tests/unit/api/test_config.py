...
class TestAPISettings:
    ...
    def test_custom_rate_limiting(self):
        ...
        settings = APISettings(rate_limit_enabled=False, rate_limit_requests=120)
    ...
    def test_custom_byok_settings(self):
        ...
        settings = APISettings(enable_byok=False, byok_services=custom_services)
    ...
    def test_settings_immutability_after_creation(self):
        ...
        settings = APISettings(access_token_expire_minutes=45, rate_limit_requests=100)

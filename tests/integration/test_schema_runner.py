...
class SchemaTestRunner:
    ...
    async def _run_test_suite(self, suite: Dict[str, str]) -> Dict[str, Any]:
        ...
        try:
            ...
            test_path = f"tests/integration/{suite['module']}"
    ...
    def _generate_recommendations(
        ...
        schema_failures = [
            suite for suite in failed_suites 
        ...
        perf_tests = ["index_performance", "collaboration_performance", "performance_optimization"]
        perf_issues = [
            test for test in slow_tests
...
async def main():
    ...
    if args.quick:
        config["test_types"] = ["schema_validation", "rls_policies", "foreign_key_constraints"]

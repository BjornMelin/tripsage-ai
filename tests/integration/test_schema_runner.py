    ...
    def _generate_recommendations(
        ...
        if slow_tests:
            recommendations.append(
                f"Consider optimizing {len(slow_tests)} slow test suites for better "
                f"CI/CD performance"
            )
        ...
        if schema_failures:
            recommendations.append(
                "Critical schema validation failures detected - review database "
                "migration safety"
            )
        ...
        if security_failures:
            recommendations.append(
                "Security test failures detected - review RLS policies "
                "and data isolation"
            )

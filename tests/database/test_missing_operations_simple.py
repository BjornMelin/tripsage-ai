...
def test_missing_operations():
    ...
    supabase_tools_path = "/home/bjorn/repos/agents/openai/tripsage-ai/tripsage/tools/supabase_tools.py"
    memory_tools_path = "/home/bjorn/repos/agents/openai/tripsage-ai/tripsage/tools/memory_tools.py"

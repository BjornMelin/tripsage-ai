    ...
    def test_generate_missing_operations_report(self):
        ...
        for category, operations in report.items():
            for op in operations:
                priority_groups[op["priority"]].append({
                    "category": category,
                    **op
                })
    ...
    def test_missing_flight_model(self):
        ...
        missing_model = {
            ...
            "fields": [
                ...
                "arrival_time", "airline", "booking_status",
...
if __name__ == "__main__":
    ...
    print(f"\n=== Missing Models ===")
    print(f"- {flight_model['model']}: {flight_model['description']} (Priority: {flight_model['priority']})")
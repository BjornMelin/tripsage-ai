...
async def authenticated_websocket_connection(websocket_settings):
    ...
    with patch('tripsage.api.middlewares.authentication.verify_jwt_token') as mock_verify:
        mock_verify.return_value = {"user_id": "test-user-123", "email": "test@example.com"}
        
        # Create WebSocket connection
        uri = f"ws://localhost:8000/ws/test-user-123"
...
class TestWebSocketAuthenticationPerformance:
    ...
    async def test_jwt_verification_performance(self, benchmark):
        ...
        async def verify_jwt_token():
            ...
            # Mock JWT token
            mock_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoiMTIzIiwiZXhwIjoxNjAwMDAwMDAwfQ.test"

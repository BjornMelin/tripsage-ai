...
def mock_memory_client():
        ...
        return_value=[
            {
                ...
                "entityType": "Trip",
                "observations": [
                    "Test Trip from 2023-01-01 to 2023-01-07",
                    "Budget: $1000",
                ],
            },
            {
    ...
    client.add_observations = AsyncMock(
        return_value=[
            {"entityName": "Trip:test-trip-id", "observations": ["Updated information"]}
        ]
    )

...
def main():
    try:
        ...
        class_attrs = {
            "WebCrawlMCPConfig": ["crawl4ai_api_key", "crawl4ai_auth_token", "crawl4ai_timeout", 
                                 "crawl4ai_max_depth", "crawl4ai_default_format"],
            "PlaywrightMCPConfig": ["headless", "browser_type", "timeout"],
            "StagehandMCPConfig": ["browserbase_api_key", "browserbase_project_id", "recovery_enabled"],
            "TimeMCPConfig": ["default_timezone", "use_system_timezone", "format_24_hour"],
            "DockerMCPConfig": ["image_registry", "socket_path", "max_container_count"],
            "OpenAPIMCPConfig": ["schema_url", "authentication_type", "default_timeout"]
        }

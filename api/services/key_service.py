...
class KeyService:
    ...
    async def save_key(self, user_id: str, service: str, api_key: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Error saving API key for user {user_id}, service {service}: {str(e)}")
            return False
    ...
    async def get_key(self, user_id: str, service: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error retrieving API key for user {user_id}, service {service}: {str(e)}")
            return None
    ...
    async def delete_key(self, user_id: str, service: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Error deleting API key for user {user_id}, service {service}: {str(e)}")
            return False

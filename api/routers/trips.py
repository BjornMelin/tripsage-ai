...
from api.deps import get_current_user, get_storage_service, get_session_memory
...
async def list_trips(
    ...
    limit: int = Query(10, ge=1, le=100, description="Limit the number of trips returned"),
    current_user: dict = Depends(get_current_user),
    trip_service: TripService = Depends(),
):

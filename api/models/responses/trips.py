...
from api.models.requests.trips import TripDestination, TripPreferences
...
class TripSummaryResponse(BaseModel):
    ...
    duration_days: int = Field(..., description="Trip duration in days")
    destinations: List[str] = Field(..., description="Trip destination names")
    accommodation_summary: Optional[str] = Field(None, description="Accommodation summary")
    transportation_summary: Optional[str] = Field(None, description="Transportation summary")

...
export const createCompleteQueryBuilder = (mockData: any = null, mockError: any = null) => ({
...
export const createMockTableBuilder = (mockResponse: any = { data: null, error: null }) =>
  vi.fn().mockImplementation(() => createCompleteQueryBuilder(mockResponse.data, mockResponse.error));

// For functions that need table-specific logic
export const createMockTableBuilderWithTable = (mockResponse: any = { data: null, error: null }) =>
  vi.fn().mockImplementation((table: string) => createCompleteQueryBuilder(mockResponse.data, mockResponse.error));
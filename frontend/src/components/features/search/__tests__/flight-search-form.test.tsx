...
describe('FlightSearchForm', () => {
  ...
  it('handles form submission with valid data', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('City or airport'), { target: { value: 'New York' } });
    fireEvent.change(screen.getAllByPlaceholderText('City or airport')[1], { target: { value: 'London' } });

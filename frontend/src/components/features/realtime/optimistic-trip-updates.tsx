...
export function OptimisticTripUpdates({ tripId }: OptimisticTripUpdatesProps) {
  ...
  const handleOptimisticUpdate = async (field: keyof TripUpdate, value: any) => {
    ...
    try {
      ...
      const currentTrip = queryClient.getQueryData(['trip', tripId]) as Trip | undefined;
      if (currentTrip) {
        setTrip(currentTrip);
      }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edit your trip details. Changes are saved automatically and shared with collaborators in real-time.
          </CardDescription>
        </CardHeader>

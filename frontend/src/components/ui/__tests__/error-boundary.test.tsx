...
import { ErrorBoundary, GracefulErrorBoundary, ErrorFallback, CompactErrorFallback } from "../error-boundary"
...
describe("GracefulErrorBoundary", () => {
  ...
  it("shows notification when error occurs but preserves content", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/some content failed to load properly/i)).toBeInTheDocument()
    })
  })
})
...
describe("ErrorFallback", () => {
  ...
  it("applies custom className", () => {
    ...
    const errorContainer = screen.getByText(/oops! something went wrong/i).closest("div")

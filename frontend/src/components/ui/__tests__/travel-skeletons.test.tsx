...
describe("HotelSkeleton", () => {
  ...
  it("includes image skeleton", () => {
    ...
    const imageSkeletons = container.querySelectorAll("[class*='h-48'], [height='200px']");
...
describe("TripSkeleton", () => {
  ...
  it("includes image and trip details", () => {
    ...
    // Should have image skeleton
    const imageSkeletons = container.querySelectorAll("[class*='h-40'], [height='160px']");
    expect(imageSkeletons.length).toBeGreaterThan(0);
...
describe("DestinationSkeleton", () => {
  it("renders destination card skeleton", () => {
    ...
    expect(destination).toHaveAttribute("aria-label", "Loading destination information");
  });
...
describe("SearchFilterSkeleton", () => {
  ...
  it("includes checkbox-style filter items", () => {
    ...
    const checkboxSkeletons = container.querySelectorAll("[class*='h-4'][class*='w-4'], [class*='h-3'][class*='w-3']");

        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {Array.from({ length: 4 }).map((_, index) => (
              <Skeleton key={index} height="1.5rem" width="80px" className="rounded-full" />
            ))}
          </div>
...
export const DestinationSkeleton = React.forwardRef<HTMLDivElement, DestinationSkeletonProps>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {Array.from({ length: 3 }).map((_, index) => (
              <Skeleton key={index} height="1.5rem" width="60px" className="rounded-full" />
            ))}
          </div>
        </div>
      </div>
...
export const ItineraryItemSkeleton = React.forwardRef<HTMLDivElement, ItineraryItemSkeletonProps>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
...
export const ChatMessageSkeleton = React.forwardRef<HTMLDivElement, ChatMessageSkeletonProps>(
...
export const SearchFilterSkeleton = React.forwardRef<HTMLDivElement, SearchFilterSkeletonProps>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}

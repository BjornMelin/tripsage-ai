...
import { ErrorFallback, MinimalErrorFallback, PageErrorFallback } from "../error-fallback";
...
describe("Error Fallback Components", () => {
  ...
  describe("MinimalErrorFallback", () => {
    it("should render minimal error UI", () => {
      ...
      expect(screen.getByText("The application has encountered an unexpected error and needs to restart.")).toBeInTheDocument();
      expect(screen.getByTestId("alert-triangle-icon")).toBeInTheDocument();
    });
    ...
    it("should not render restart button when reset function not provided", () => {
      ...
      expect(screen.queryByRole("button", { name: /restart application/i })).not.toBeInTheDocument();
    });

    it("should have full screen layout", () => {
      const { container } = render(<MinimalErrorFallback error={mockError} reset={mockReset} />);
  ...
  describe("PageErrorFallback", () => {
    it("should render page error UI", () => {
      ...
      expect(screen.getByText("This page has encountered an error and cannot be displayed properly.")).toBeInTheDocument();
      expect(screen.getByTestId("alert-triangle-icon")).toBeInTheDocument();
    });
  ...
  describe("responsive design", () => {
    it("should have responsive classes", () => {
      const { container } = render(<PageErrorFallback error={mockError} reset={mockReset} />);
    ...
    it("should have proper spacing classes", () => {
      ...
      expect(screen.getByText("Something went wrong").closest(".space-y-4")).toBeInTheDocument();
    });
  });
});
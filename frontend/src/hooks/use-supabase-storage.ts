...
export function useSupabaseStorage() {
  ...
  const useFileAttachments = useCallback((filters?: {
    tripId?: number;
    chatMessageId?: number;
  ...
  const useFileAttachment = useCallback((attachmentId: string | null) => {
    return useQuery({
  ...
  const getDownloadUrl = useCallback(async (attachment: FileAttachment) => {
  ...
  const getPublicUrl = useCallback((attachment: FileAttachment) => {

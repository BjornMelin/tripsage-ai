...
export function useAuthenticatedApi() {
  ...
  const authenticatedApi = useMemo(() => ({
    ...
    patch: <T = any>(endpoint: string, data?: any, options?: Omit<FetchOptions, 'method' | 'body'>) =>
      makeAuthenticatedRequest<T>(endpoint, {
        ...options,
        method: "PATCH",
        body: data ? JSON.stringify(data) : undefined,
    ...
    // For file uploads
    upload: <T = any>(endpoint: string, formData: FormData, options?: Omit<FetchOptions, 'method' | 'body'>) =>
      makeAuthenticatedRequest<T>(endpoint, {
        ...options,
        method: "POST",
        body: formData,

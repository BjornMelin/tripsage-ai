...
describe("extractSafetyCategories", () => {
  ...
  test("includes description from relevant sentence", () => {
    ...
    const categories = extractSafetyCategories(summary);
    const crimeCategory = categories.find((c) => c.category === "crime");

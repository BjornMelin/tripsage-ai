 ...
 */
export async function sendChatRequest(request: ChatCompletionRequest): Promise<ChatCompletionResponse> {
  try {
...
export function streamChatRequest(
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch('/api/chat', {  // Updated to use /api/chat instead of /api/chat/stream
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },

...
- Name: Error Boundaries and Loading States >> Error Boundaries >> should catch and display route-level errors gracefully
- Location: /home/bjorn/repos/agents/openai/agent1/tripsage-ai/frontend/e2e/error-boundaries-loading.spec.ts:90:9
...
Call log:
  ...
  - waiting for locator('text=Something went wrong')
    ...
    at /home/bjorn/repos/agents/openai/agent1/tripsage-ai/frontend/e2e/error-boundaries-loading.spec.ts:102:63
```

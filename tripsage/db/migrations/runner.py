...
class MigrationRunner:
    ...
    async def ensure_migrations_table(self) -> None:
        ...
        try:
            ...
            result = self.client.table("migrations").select("id").limit(1).execute()
    ...
    async def record_migration(self, filename: str, checksum: str) -> bool:
        ...
        try:
            result = self.client.table("migrations").insert({
                "filename": filename,
                "checksum": checksum,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--up-to", 
        help="Apply migrations up to and including this filename"
    )

...
class DocumentAnalyzer:
    ...
    def __init__(self):
        ...
        self.analysis_templates = {
            ...
            "travel_document": {
                ...
                "fields": ["document_type", "document_number", "validity_dates", "issuing_authority"]
            },
            "general": {
    ...
    async def analyze_document(self, context: AnalysisContext, analysis_type: str = "general") -> DocumentAnalysisResult:
        """
    ...
    async def _analyze_text_with_ai(self, text: str, analysis_type: str, user_context: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def _find_travel_keywords(self, text: str) -> List[str]:
        ...
        travel_keywords = {
            ...
            "destination", "travel", "trip", "vacation", "holiday",
            "passport", "visa", "itinerary", "ticket", "confirmation",
            "check-in", "checkout", "baggage", "luggage"
        }
    ...
    def _extract_travel_information(self, analysis_results: Dict[str, Any], text: str) -> Optional[TravelInformation]:
        ...
        try:
            ...
            activity_keywords = [kw for kw in keywords if kw in ["vacation", "holiday", "trip"]]
    ...
    async def batch_analyze_documents(self, contexts: List[AnalysisContext], analysis_type: str = "general") -> List[DocumentAnalysisResult]:
        """

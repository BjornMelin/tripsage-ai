...
A comprehensive FastAPI implementation that serves both frontend applications and AI
...
TAG_DESCRIPTIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "and JWT token management. Primary authentication method for "
            "frontend consumers."
        ),
    },
    {
    ...
    },
    {
        ...
        "description": (
            ...
            "Provides comprehensive destination information, weather, and "
            "recommendations."
        ),
    },
    {
        "name": "itineraries",
        "description": (
            "Itinerary building and optimization endpoints. Intelligent trip "
            "scheduling with route optimization and activity coordination."
        ),
    },
    {
        "name": "chat",
        "description": (
            ...
            "Supports session management and conversation history for both "
            "frontend and agent consumers."
        ),
    },
    {
        "name": "memory",

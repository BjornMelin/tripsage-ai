...
def get_websocket_manager_dep(request: Request) -> WebSocketManager:
    """Get DI-managed WebSocket manager instance."""
    return _get_required_service(request, "websocket_manager", WebSocketManager)


def get_websocket_broadcaster_dep(
    request: Request,
) -> WebSocketBroadcaster:
    """Get DI-managed WebSocket broadcaster instance."""
    return _get_required_service(request, "websocket_broadcaster", WebSocketBroadcaster)

...
async def test_register_user(async_client: AsyncClient):
    ...
    with patch("tripsage.api.services.user.UserService.get_user_by_email", new_callable=AsyncMock) as mock_get_user, \
         patch("tripsage.api.services.user.UserService.create_user", new_callable=AsyncMock) as mock_create_user:
...
async def test_login(async_client: AsyncClient):
    ...
    with patch("tripsage.api.services.auth.AuthService.authenticate_user", new_callable=AsyncMock) as mock_auth:
...
async def test_refresh_token(async_client: AsyncClient):
    ...
    """
    # Mock the auth service
    with patch("tripsage.api.services.auth.AuthService.validate_refresh_token", new_callable=AsyncMock) as mock_validate:

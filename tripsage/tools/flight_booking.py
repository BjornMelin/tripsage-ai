...
class TripSageFlightBooking:
    ...
    async def get_booking_details(self, booking_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            booking_entity = await memory_client.open_nodes([f"Booking:{booking_id}"])
            if booking_entity:
                return {
                    "success": True,
                    "booking_id": booking_id,
    ...
    async def cancel_booking(self, booking_id: str) -> Dict[str, Any]:
        ...
        try:
            cancellation_result = await self.flights_client.cancel_booking(booking_id)
            ...
            try:
                ...
                logger.warning(f"Error updating booking in knowledge graph: {str(e)}")
...
flight_booking = TripSageFlightBooking()

"""
Google Maps related schemas for TripSage tools.

This module provides Pydantic models for validating Google Maps related data
when interacting with the Google Maps MCP server.
"""
...
class GeocodeParams(TripSageModel):
...
class ReverseGeocodeParams(TripSageModel):
...
class PlaceSearchParams(TripSageModel):
...
class PlaceDetailsParams(TripSageModel):
...
class DirectionsParams(TripSageModel):
...
class DistanceMatrixParams(TripSageModel):
...
class TimeZoneParams(TripSageModel):
...
class ElevationParams(TripSageModel):
...
class GeocodeResult(TripSageModel):
...
class GeocodeResponse(TripSageBaseResponse):
...
class PlaceResult(TripSageModel):
...
class PlaceSearchResponse(TripSageBaseResponse):
...
class PlaceDetailsResponse(TripSageBaseResponse):
...
class DirectionsResponse(TripSageBaseResponse):
...
class DistanceMatrixResponse(TripSageBaseResponse):
...
class TimeZoneResponse(TripSageBaseResponse):
...
class ElevationResponse(TripSageBaseResponse):

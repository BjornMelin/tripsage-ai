...
- **Follow-up (pre-GA):** Map current codes to the planned standard set (see mapping table). This must be completed before BYOK is generally available; tracking: issue draft placeholder [#9999](https://github.com/tripsage-ai/tripsage/issues/9999) with owner + target milestone.

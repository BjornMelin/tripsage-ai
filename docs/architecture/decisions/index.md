...
This is the canonical entry point for Architecture Decision Records (ADRs).

## Final baseline ADRs (2026-01-05)

- [ADR-0059: BotID Integration for Chat and Agent Endpoints](adr-0059-botid-chat-and-agents.md)
- [ADR-0060: Supabase Storage for Chat Attachments](adr-0060-supabase-storage-attachments.md)
- [ADR-0061: RSC shell + TanStack Query “doughnut” architecture](adr-0061-rsc-shell-tanstack-query-doughnut.md)
- [ADR-0062: Server Actions transport and Route Handler policy](adr-0062-server-actions-transport-and-route-handler-policy.md)
